    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 p-4">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-8 animate-fade-in-up">
          <div className="w-20 h-20 bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse-slow">
      ...
      <Dialog open={isDetailOpen} onOpenChange={setIsDetailOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {selectedContract.tenderNoticeUrl ? (
                        <Button
                          className="w-full justify-start border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 h-8 px-3 text-sm"
                          onClick={() => {
                      ...
                      {selectedContract.tenderDocuments?.length > 0 && (
                        <>
                          ...
                          {selectedContract.tenderDocuments.map((doc: any, index: number) => (
                        <Button
                          key={index}
                          className="w-full justify-start border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 h-8 px-3 text-sm"
                        >
          ...
          <div className="flex justify-end gap-2 pt-4">
            <Button className="border border-gray-300 bg-white text-gray-700 hover:bg-gray-50" onClick={() => setIsDetailOpen(false)}>
      ...
      <Dialog open={isProgressOpen} onOpenChange={setIsProgressOpen}>
        <DialogContent className="max-w-6xl w-[95vw] max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-6 rounded-lg">
                  <div className="grid lg:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-3">{t(selectedContract.title)}</h3>
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col items-center lg:items-end">
                      <div className="text-center">
                        <div className="text-4xl lg:text-5xl font-bold text-orange-600 mb-2">{selectedContract.progress}%</div>
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <h5 className="font-semibold text-gray-700 text-sm">{t({ en: 'Original Budget', mr: 'मूळ बजेट' })}</h5>
                          <p className="text-lg font-bold text-blue-600">{formatCurrency(selectedContract.estimatedBudget)}</p>
                        </div>
                        <div className="space-y-1">
                          <h5 className="font-semibold text-gray-700 text-sm">{t({ en: 'Contact Person', mr: 'संपर्क व्यक्ती' })}</h5>
                          <div className="text-gray-600">
                            <p className="font-medium">{t(selectedContract.contactName)}</p>
                            <p className="text-sm text-gray-500">{selectedContract.contactPhone}</p>
                          </div>
                        </div>
                        <div className="space-y-1">
                          <h5 className="font-semibold text-gray-700 text-sm">{t({ en: 'Tender Issue Date', mr: 'निविदा जारी दिनांक' })}</h5>
                          <p className="text-gray-600">{formatDate(selectedContract.issueDate)}</p>
                        </div>
                        <div className="space-y-1">
                          <h5 className="font-semibold text-gray-700 text-sm">{t({ en: 'Tender Deadline', mr: 'निविदा मुदत' })}</h5>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <h5 className="font-semibold text-gray-700 text-sm">{t({ en: 'Contractor', mr: 'कंत्राटदार' })}</h5>
                          <p className="text-gray-600">{t(selectedContract.contractor)}</p>
                        </div>
                        <div className="space-y-1">
                          <h5 className="font-semibold text-gray-700 text-sm">{t({ en: 'Budget Allocated', mr: 'वाटप केलेले बजेट' })}</h5>
                          <p className="text-xl font-bold text-orange-600">{formatCurrency(selectedContract.allocatedBudget)}</p>
                        </div>
                        <div className="space-y-1">
                          <h5 className="font-semibold text-gray-700 text-sm">{t({ en: 'Start Date', mr: 'सुरुवात दिनांक' })}</h5>
                          <p className="text-gray-600">{formatDate(selectedContract.startDate)}</p>
                        </div>
                        <div className="space-y-1">
                          <h5 className="font-semibold text-gray-700 text-sm">{t({ en: 'Expected Completion', mr: 'अपेक्षित पूर्णता' })}</h5>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                      ...
                      <div className="space-y-3">
                        {selectedContract.timeline && selectedContract.timeline.length > 0 ? (
                          selectedContract.timeline.map((phase: any, index: number) => (
                            <div key={index} className="flex items-center gap-3 p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border-l-4 border-l-orange-400">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="font-semibold text-gray-800 text-sm lg:text-base">{t(phase.phase)}</div>
                              ...
                              {phase.completed && (
                                <Badge className="bg-green-500 text-white px-2 py-1 text-xs flex-shrink-0">
                          ...
                          <div className="text-center py-6 bg-gray-50 rounded-lg">
                            ...
                            <p className="text-gray-500 italic text-sm">{t({ en: 'No timeline information available', mr: 'वेळापत्रक माहिती उपलब्ध नाही' })}</p>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg shadow-sm border">
                      <h4 className="font-bold text-base mb-3 text-gray-800">{t({ en: 'Site Photos', mr: 'साइट फोटो' })}</h4>
                      {selectedContract.sitePhotos && selectedContract.sitePhotos.length > 0 ? (
                        <div className="space-y-3">
                          <div className="grid grid-cols-1 gap-3">
                            {selectedContract.sitePhotos.slice(0, 3).map((photo: any, index: number) => (
                              <ImageWithFallback
                                key={index}
                                src={photo}
                                ...
                                onClick={() => {
                                  setSelectedContract({...selectedContract as any, currentPhotoIndex: index});
                                  setIsSitePhotosOpen(true);
                                }}
                              />
                            ))}
                          ...
                          {selectedContract.sitePhotos.length > 3 && (
                            <Button 
                              className="w-full text-xs border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 h-8 px-3"
                              onClick={() => {
                        ...
                        <p className="text-gray-500 italic text-center py-4 text-sm">{t({ en: 'No site photos available', mr: 'साइट फोटो उपलब्ध नाहीत' })}</p>
                      )}
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm border">
                      ...
                      <div className="space-y-3">
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-3 rounded-lg">
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-gray-700 font-medium text-sm">{t({ en: 'Days Remaining', mr: 'दिवस शिल्लक' })}</span>
                            </div>
                            <span className="text-lg font-bold text-blue-600">
                            {selectedContract.expectedCompletionDate ? 
                              Math.max(0, Math.ceil((new Date(selectedContract.expectedCompletionDate).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24))) : 
                              'N/A'
                            }
                            </span>
                          </div>
                        ...
                        <div className="bg-gradient-to-r from-green-50 to-green-100 p-3 rounded-lg">
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-gray-700 font-medium text-sm">{t({ en: 'Budget Used', mr: 'वापरलेले बजेट' })}</span>
                            </div>
                        ...
                        <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-3 rounded-lg">
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-2">
                              <Wallet className="h-3 w-3 text-orange-600 flex-shrink-0" />
                              <span className="text-gray-700 font-medium text-sm">{t({ en: 'Budget Remaining', mr: 'बजेट शिल्लक' })}</span>
                            </div>
                        ...
                        <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-3 rounded-lg">
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-gray-700 font-medium text-sm">{t({ en: 'Budget Variance', mr: 'बजेट फरक' })}</span>
                            </div>
                            <span className={`text-sm font-bold ${selectedContract.allocatedBudget > selectedContract.estimatedBudget ? 'text-green-600' : selectedContract.allocatedBudget < selectedContract.estimatedBudget ? 'text-red-600' : 'text-gray-600'}`}>
          ...
          <div className="flex justify-end gap-2 pt-4 border-t flex-shrink-0">
            <Button className="border border-gray-300 bg-white text-gray-700 hover:bg-gray-50" onClick={() => setIsProgressOpen(false)}>
              {t({ en: 'Close', mr: 'बंद करा' })}
            </Button>
          </div>
        </DialogContent>
      ...
      <Dialog open={isReportOpen} onOpenChange={setIsReportOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  {selectedContract.finalPhotos && selectedContract.finalPhotos.length > 1 && (
                    <div className="grid grid-cols-2 gap-2 mt-2">
                      {selectedContract.finalPhotos.slice(1, 5).map((photo: any, index: number) => (
                        <ImageWithFallback
                          key={index}
                          src={photo}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {selectedContract.deliverables?.map((item: any, index: number) => (
          ...
          <div className="flex justify-end gap-2 pt-4">
            <Button className="border border-gray-300 bg-white text-gray-700 hover:bg-gray-50" onClick={() => setIsReportOpen(false)}>
              {t({ en: 'Close', mr: 'बंद करा' })}
            </Button>
          </div>
        </DialogContent>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          {selectedContract && selectedContract.sitePhotos && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {selectedContract.sitePhotos.map((photo: any, index: number) => (
                  <div key={index} className="group relative">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 rounded-lg flex items-center justify-center">
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <Button 
                          className="bg-gray-100 text-gray-700 hover:bg-gray-200 h-8 px-3 text-sm"
                          onClick={() => window.open(photo, '_blank')}
                        >
                          <Eye className="h-4 w-4 mr-2" />
          ...
          <div className="flex justify-end gap-2 pt-4 border-t">
            <Button className="border border-gray-300 bg-white text-gray-700 hover:bg-gray-50" onClick={() => setIsSitePhotosOpen(false)}>
              {t({ en: 'Close', mr: 'बंद करा' })}
            </Button>
          </div>
        </DialogContent>
